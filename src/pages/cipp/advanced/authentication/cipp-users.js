...
const Page = () => {
  return (
    <CippPageCard hideBackButton={true} title={"ŌMZIG User Management"}>
      <CardContent>
        <Stack spacing={2}>
          <Alert severity="info">
            Manage users who can access CIPP. Users are automatically synced from your partner
            tenant every 15 minutes based on Entra group memberships configured on the ŌMZIG Roles
            ...
            superadmin role have full access to ŌMZIG and all other permissions applied will be ignored.
            You must have at least one superadmin user in ŌMZIG at all times, and you cannot remove the
            ...
            appropriate roles in ŌMZIG or enable the multi tenant mode in the SSO tab and add the users
